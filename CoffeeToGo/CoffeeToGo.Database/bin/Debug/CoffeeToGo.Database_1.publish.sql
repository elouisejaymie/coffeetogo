...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL12.SQLSERVER2014\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL12.SQLSERVER2014\MSSQL\DATA\"
...
GO
ALTER TABLE [dbo].[BeverageIngredient] WITH CHECK CHECK CONSTRAINT [FK_BeverageIngredient_Beverage];

ALTER TABLE [dbo].[BeverageIngredient] WITH CHECK CHECK CONSTRAINT [FK_BeverageIngredient_Ingredient];

ALTER TABLE [dbo].[Orders] WITH CHECK CHECK CONSTRAINT [FK_Orders_Beverage];
